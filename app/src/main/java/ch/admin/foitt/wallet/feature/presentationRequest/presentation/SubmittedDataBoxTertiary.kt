...
@Composable
internal fun SubmittedDataBoxTertiary(
    fields: List<String>,
) {
    Surface(
        ...
        Column(
            modifier = Modifier
                .background(WalletTheme.colorScheme.tertiaryContainer)
                .fillMaxWidth()
...
private fun Field(text: String) {
    Row(verticalAlignment = Alignment.CenterVertically) {
        Icon(
            ...
            tint = WalletTheme.colorScheme.onTertiaryContainer,
            contentDescription = null,
        )
        Spacer(Modifier.width(Sizes.s01))
        WalletTexts.Body(
            text = text,
            color = WalletTheme.colorScheme.onTertiaryContainer
        )
