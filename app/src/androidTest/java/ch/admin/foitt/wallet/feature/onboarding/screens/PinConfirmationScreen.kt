...
class PinConfirmationScreen(composeTestRule : ComposeContentTestRule) : OnboardingBaseScreen(composeTestRule) {
    ...
    override fun isDisplayed() {
        composeTestRule.waitUntilAtLeastOneExists(hasText("Confirm code (deepl)"), 10000)
        title.assertIsDisplayed()
        title.assertTextEquals("Confirm code (deepl)")
