...
class PasswordEntryScreen(composeTestRule : ComposeContentTestRule) : OnboardingBaseScreen(composeTestRule) {
    ...
    override fun isDisplayed() {
        composeTestRule.waitUntilAtLeastOneExists(hasText("Enter password"), 10000)
        title.assertIsDisplayed()
        title.assertTextEquals("Enter password")
    ...
    fun navigateToScreen() {
        val pinExplanationScreen = OnboardingPasswordExplanationScreen(composeTestRule)
