...
internal sealed interface FetchVerifiableCredentialError
internal sealed interface FetchIssuerConfigurationError
...
internal fun Throwable.toFetchCredentialError(): FetchCredentialError {
    Timber.e(this)
